...
public class Map_Activity extends Fragment {
   ...
   /* @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        Intent intent;
        if (id == R.id.home) {
            intent = new Intent(Map_Activity.this, Home_Activity.class);
            startActivity(intent);
            return true;
        } else if (id == R.id.profile) {
            intent = new Intent(Map_Activity.this, Profile_Activity.class);
            startActivity(intent);
            return true;
        } else if (id == R.id.to_do_list) {
            intent = new Intent(Map_Activity.this, ToDo_Activity.class);
            startActivity(intent);
            return true;
        } else if (id == R.id.materials) {
            intent = new Intent(Map_Activity.this, Materials_Activity.class);
            startActivity(intent);
            return true;
        } else if (id == R.id.map) {
